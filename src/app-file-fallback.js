// Generated by tools/build-file-fallback.mjs. Do not edit by hand.
...
var MATERIAL_SWATCHES = Object.freeze([
  {
...
function pixelToMaterial({ r, g, b, a = 255 }) {
  if (a === 0) {
    return null;
  }
...
function summarizeDesignPixels(imageData, options = {}) {
...
// ---- src/simulation.js ----
function runEggDropSimulation(imageData, userOptions = {}) {
...
function createBlankImageData(width = DEFAULTS.imageWidth, height = DEFAULTS.imageHeight, rgba = [84, 227, 108, 255]) {
...
function imageDataToCsv(result) {
